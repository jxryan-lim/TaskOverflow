...
namespace TaskOverflow.Migrations
{
    ...
    [Migration("20260228100045_AddNestedSubtaskSupport")]
    partial class AddNestedSubtaskSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TaskOverflow.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TaskOverflow.Models.TaskItem", b =>
                {
                    b.HasOne("TaskOverflow.Models.ApplicationUser", "User")
                        .WithMany("Tasks")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
